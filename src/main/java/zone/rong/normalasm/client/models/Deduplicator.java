package zone.rong.normalasm.client.models;
...
import zone.rong.normalasm.api.HashingStrategies;
...
public class Deduplicator {
    ...
    // private static final MethodHandle UNPACKED_DATA_SETTER = NormalReflector.resolveFieldSetter(UnpackedBakedQuad.class, "unpackedData");
        ...
        if (o instanceof IBakedModel) {
            if (o instanceof SimpleBakedModel) {
                /* TODO: SimpleBakedModel$Builder can transform BakedQuads => BakedQuadRetextureds if the ctor with IBakedModel is used.
                    ...
                    This isn't a big deal atm since NormalASM optimizes BakedQuadRetextureds as well.
                 */
    ...
    private Object canonicalize(Object o) {
        ...
        if (n != o) {
            NormalLogger.instance.info("Deduplicated {}@{} => {}@{} successfully", o.getClass().getName(), Integer.toHexString(o.hashCode()), n.getClass().getName(), Integer.toHexString(n.hashCode()));
        }
        return n;
    }
