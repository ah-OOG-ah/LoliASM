package zone.rong.normalasm.client.models.bucket.mixins;
...
import static zone.rong.normalasm.bakedquad.BakedQuadFactory.*;
import static zone.rong.normalasm.client.models.bucket.NormalBakedDynBucket.*;
...
public abstract class ModelDynBucketMixin implements IModel {
    ...
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        return new NormalBakedDynBucket((ModelDynBucket) (Object) this, builder.build(), particleSprite, format, transformMap, transform.isIdentity());
    }
}
