...
public class GuiWarningScreen extends GuiProblemScreen {
    ...
    public void initGui() {
        super.initGui();
        buttonList.add(new GuiButton(0, width / 2 - 155,  height / 4 + 120 + 12, 150, 20, I18n.format("normalasm.gui.keepPlaying")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) { // TODO: localize number of lines
        ...
        drawCenteredString(fontRenderer, I18n.format("normalasm.warnscreen.title"), width / 2, height / 4 - 40, 0xFFFFFF);
