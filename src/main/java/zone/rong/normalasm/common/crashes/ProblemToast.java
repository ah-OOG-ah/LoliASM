...
public class ProblemToast implements IToast {
    ...
    public IToast.Visibility draw(GuiToast toastGui, long delta) {
        ...
        toastGui.getMinecraft().fontRenderer.drawString(cause.equals("") ?
                I18n.format("normalasm.notification.title.unknown") :
                I18n.format("normalasm.notification.title.mod", cause), 5, 7, 0xFF000000);
        toastGui.getMinecraft().fontRenderer.drawString(I18n.format("normalasm.notification.description"), 5, 18, 0xFF500050);
