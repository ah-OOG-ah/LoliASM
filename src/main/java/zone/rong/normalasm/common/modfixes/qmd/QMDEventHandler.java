package zone.rong.normalasm.common.modfixes.qmd;
...
public class QMDEventHandler {
    ...
    private static final Class<?> projectileClass = NormalReflector.getClass("lach_01298.qmd.entity.EntityBeamProjectile").get();
