package zone.rong.normalasm.common.singletonevents;
 ...
 *
 * 1. Have a unique field: { private EventPriority normalPriority = null; }
 * 2. Override {@link Event#getPhase()} and {@link Event#setPhase(EventPriority)}
 * 3. Point normalPriority towards those getters/setters
