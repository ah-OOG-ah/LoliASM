package zone.rong.normalasm.core.classfactories;
...
import zone.rong.normalasm.bakedquad.BakedQuadClassFactory;
...
public class BakedQuadRedirectorFactory {
    ...
    public static String generateRedirectorClass() {
        ...
        final String className = "zone.rong.normalasm.client.models.bakedquad.mixins.NewBakedQuadCallsRedirector";
        ...
        if (!NormalTransformer.squashBakedQuads) {
            NormalLogger.instance.info("Defining a mock NewBakedQuadCallsRedirector Mixin.");
            ...
            String[] targetNames = NormalConfig.instance.classesThatCallBakedQuadCtor;

            NormalLogger.instance.info("Defining NewBakedQuadCallsRedirector Mixin. With these mixin targets: {}", (Object) targetNames);
            ...
            for (String methodName : new String[] { "redirect", "staticRedirect", "deprecatedRedirect", "staticDeprecatedRedirect"} ) {
                ...
                methodVisitor.visitMethodInsn(INVOKESTATIC, "zone/rong/normalasm/bakedquad/BakedQuadFactory", NormalConfig.instance.vertexDataCanonicalization ? "canonicalize" : "prepare", "([IILnet/minecraft/util/EnumFacing;Lnet/minecraft/client/renderer/texture/TextureAtlasSprite;ZLnet/minecraft/client/renderer/vertex/VertexFormat;)Lnet/minecraft/client/renderer/block/model/BakedQuad;", false);
        ...
        NormalReflector.defineMixinClass(className, writer.toByteArray());
